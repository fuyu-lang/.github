...
- Follow the Fuyu code conventions (https://github.com/fuyu-lang/.github/blob/main/CONTRIBUTING.md#code-conventions).
- Follow the pull request guidelines (https://github.com/fuyu-lang/.github/blob/main/CONTRIBUTING.md#pull-requests).
-->
